  ...
  const rows = await withDbRetry(() =>
    db
      .select({
        ...
        dnsConnectionId: sites.dnsConnectionId,
        dnsZoneId: sites.dnsZoneId,
        dnsZoneName: sites.dnsZoneName,
        crawlHost: sites.crawlHost,
        crawlOriginIp: sites.crawlOriginIp,
        crawlRecordId: sites.crawlRecordId,
        crawlHostCreatedAt: sites.crawlHostCreatedAt,
